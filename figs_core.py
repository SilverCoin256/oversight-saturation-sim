...
"""Regenerate the saturation-transitions figure (Figure 2) as a REAL plot, so the
revised manuscript is self-contained. Uses the same model as the paper. The noise-stress
figure (Figure 6) is generated by revision_hardening.py (R3), which is the authoritative
source cited in the manuscript's Reproducibility section — it is not duplicated here."""
import math, numpy as np
import matplotlib; matplotlib.use("Agg"); import matplotlib.pyplot as plt
from experiments import degradation_exp, kingman_lq
...
import json
print(json.dumps(dict(kingman_max_relerr=round(king_err,3)), indent=1))
